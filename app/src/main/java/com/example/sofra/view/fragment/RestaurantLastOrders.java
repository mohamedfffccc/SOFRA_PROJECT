 ...
 */
public class RestaurantLastOrders extends Fragment {
    UserApi userApi;
    ...
    @BindView(R.id.fragmentrestaurantlastorders_orderslist)
    RecyclerView fragmentrestaurantlastordersOrderslist;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_restaurant_last_orders, container, false);
        ButterKnife.bind(this, root);
        userApi = GetClient().create(UserApi.class);
        setSharedPreferences(getActivity());
        orderslist = new ArrayList<>();
        linearLayoutManager = new LinearLayoutManager(getActivity());
        fragmentrestaurantlastordersOrderslist.setLayoutManager(linearLayoutManager);
        adapter = new RestaurantOrdersAdapter(getActivity(), (BaseActivity) getActivity(), orderslist);
        fragmentrestaurantlastordersOrderslist.setAdapter(adapter);
        ...
        fragmentrestaurantlastordersOrderslist.addOnScrollListener(onEndLess);
    ...
    private void getNewOrders(String api_token, int page) {
        userApi.getMyRestaurantOrders(api_token, "completed", page).enqueue(new Callback<Orders>() {
            @Override
