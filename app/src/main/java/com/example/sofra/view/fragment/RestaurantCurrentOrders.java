 ...
 */
public class RestaurantCurrentOrders extends Fragment {
    UserApi userApi;
    ArrayList<OrdersData> orderslist;
    RestaurantOrdersAdapter adapter;
    @BindView(R.id.fragmentrestaurantcurrentorders_orderslist)
    RecyclerView fragmentrestaurantcurrentordersOrderslist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_restaurant_current_orders, container, false);
        ...
        fragmentrestaurantcurrentordersOrderslist.setLayoutManager(linearLayoutManager);
        adapter = new RestaurantOrdersAdapter(getActivity(), (BaseActivity) getActivity(), orderslist);
        fragmentrestaurantcurrentordersOrderslist.setAdapter(adapter);
        ...
        fragmentrestaurantcurrentordersOrderslist.addOnScrollListener(onEndLess);
    ...
    private void getNewOrders(String api_token, int page) {
        userApi.getMyRestaurantOrders(api_token, "current", page).enqueue(new Callback<Orders>() {
            @Override
