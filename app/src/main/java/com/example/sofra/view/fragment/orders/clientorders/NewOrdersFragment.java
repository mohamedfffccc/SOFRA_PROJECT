package com.example.sofra.view.fragment.orders.clientorders;
...
public class NewOrdersFragment extends Fragment {
    ...
    @BindView(R.id.fragmentneworders_orderslist)
    RecyclerView fragmentnewordersOrderslist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_new_orders, container, false);
        ButterKnife.bind(this, root);
        userApi = GetClient().create(UserApi.class);
        setSharedPreferences(getActivity());
        orderslist = new ArrayList<>();
        linearLayoutManager = new LinearLayoutManager(getActivity());
        fragmentnewordersOrderslist.setLayoutManager(linearLayoutManager);
        adapter = new OrdersAdapter(getActivity(), (BaseActivity) getActivity(), orderslist);
        fragmentnewordersOrderslist.setAdapter(adapter);
        ...
        fragmentnewordersOrderslist.addOnScrollListener(onEndLess);
    ...
    private void getNewOrders(String api_token , int page) {
        userApi.getMyOrders(api_token , "pending" , page).enqueue(new Callback<Orders>() {
            @Override
