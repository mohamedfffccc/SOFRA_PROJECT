package com.example.sofra.view.ordersc;
...
public class OrdersAdapter2 extends RecyclerView.Adapter<OrdersAdapter2.OrdersViewHolder> {
    ...
    public OrdersAdapter2(Context context, BaseActivity activity, List<OrdersData> orderslist) {
